...
def contains_domain(address, domain):
        ...
        if re.match(domain_pattern, address): return True
        return False


def replace_domain(address, old_domain, new_domain):
        """Replaces the old domain with the new domain
        in the received address."""
...
def main():
        ...
        USERNAME = "student-02-6511d3bb1d16"
        old_domain, new_domain = 'abc.edu', 'xyz.edu'
        csv_file_location = '/home/{}/data/user_emails.csv'.format(USERNAME)
        report_file =  '/home/{}/data/updated_user_emails.csv'.format(USERNAME)
